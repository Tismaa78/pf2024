      ...
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            ...
            Je m'appelle Mathis Roussel, je viens d'obtenir mon BTS SIO section SLAM au Lycée Jean Vilar de Plaisir et je suis actuellement en recherche d'une alternance. Mes spécialités sont le développement et la programmation.
              <br />
